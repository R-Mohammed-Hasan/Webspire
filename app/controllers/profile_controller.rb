...
class ProfileController < ApplicationController
  ...
  def edit_profile
    ...
    user.update_columns(name: params[:user][:name], email: params[:user][:email],
                        description: params[:user][:description], gender: params[:user][:gender])
  ...
  def unfollow
    friend = Follower.where('(user_id = ? and follower_id = ?) or (user_id = ? and follower_id = ?)',
